...
import { ref } from "vue";
import { i18n as coreI18n, keywords as allKeywords } from "../../sectool-core/public/sectool.addition.json";
import {
    Locale,
    ThemeType,
    toolExists,
...
const settingKey = "sectool.nv_setting";
const operateKey = "sectool.nv_operate";
...
// 版本号
export const version = document.querySelector('meta[name="sectool-version"]')?.getAttribute("content") || "dev";
// 构建时间
export const buildTimestamp = parseInt(
    document.querySelector('meta[name="sectool-build-timestamp"]')?.getAttribute("content") ||
