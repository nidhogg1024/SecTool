<template>
    <div v-row="'10-14'">
        <Align direction="vertical">
            <Display>
                <HeightResize v-slot="{height}" :append="action.current.is_salt ? ['.sectool-hash-salt'] : []" :reduce="action.current.is_salt ? 5 : 0">
            ...
            <Align direction="vertical" class="sectool-hash-salt" v-if="action.current.is_salt">
