<template>
    <HeightResize v-slot="{ height }" :append="['.sectool-page-option']">
        <div v-row="'1-1'">
    ...
    <div style="display: grid; grid-template-columns: 1fr 5px 1fr; grid-column-gap: 10px; margin-top: 5px" class="sectool-page-option">
