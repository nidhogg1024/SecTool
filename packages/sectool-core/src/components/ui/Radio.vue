...
.sectool-radio .sectool-button:not(:first-of-type,:last-of-type) button {
    border-radius: 0;
}

.sectool-radio .sectool-button:not(:last-child) {
    margin-right: -1px;
}

.sectool-radio .sectool-button button:is(:active,:focus,:hover) {
    z-index: 1;
}

.sectool-radio .sectool-button:first-of-type button {
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
}

.sectool-radio .sectool-button:last-of-type button {
