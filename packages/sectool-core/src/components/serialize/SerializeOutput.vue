<template>
    <Display position="top-right" toggle :style="style" class="sectool-serialize-output" :class="disabledBorder ? ['sectool-serialize-output-disabled-border'] : []">
...
<style>
.sectool-serialize-output-disabled-border .sectool-code-editor .cm-editor {
    border-width: 0px
}
</style>
