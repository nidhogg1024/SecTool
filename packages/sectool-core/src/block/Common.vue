<template>
    <Align direction="vertical">
        <Card :title="$t('main_common_tool')">
            <Draggable v-model="selected" class="sectool-common-tool-draggable" group="tool">
        ...
        <Card :title="$t('main_unselected_tool')">
            <Draggable v-model="unselected" class="sectool-common-tool-draggable" group="tool">
