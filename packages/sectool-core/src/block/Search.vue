<template>
    <div style="display: inline-flex;">
        ...
        <ul class="sectool-search-block" v-if="isInput" ref="container">
            <li
                v-for="(item,index) in items"
                :class="index === selectIndex ? `sectool-search-active` : ''"
                @click="select(index)"
...
.sectool-search-block li.sectool-search-active {
