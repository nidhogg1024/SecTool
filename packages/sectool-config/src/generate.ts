...
// 复制其他文件
copyFileSync(join(__dirname, '../../../', 'README.md'), join(__dirname, '../../../packages/sectool-core/public', 'README.md'))
copyFileSync(join(__dirname, '../../../', 'LICENSE'), join(__dirname, '../../../packages/sectool-core/public', 'LICENSE'))
